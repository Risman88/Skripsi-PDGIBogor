    ...
    <div class="py-4">
        <div class="flex justify-between items-center mb-4">
            ...
            <div class="flex items-center space-x-2">
                <!-- Tombol Buat Data -->
                <a href="{{ route('organisasi.create') }}" class="px-2 py-1 bg-blue-500 text-white rounded">
                    Buat Data Baru
                </a>
            </div>
        </div>
            <div class="py-4">
        @include('organisasi.partials.table', ['organisasi' => $organisasiData])
    </div>
    </div>
</x-dashboard-layout>

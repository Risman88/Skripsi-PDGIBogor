<x-dashboard-layout>
    <x-slot name="header">
        {{ __('Pengajuan Surat Rekomendasi Izin Praktik Dokter Gigi untuk Anggota PDGI Kota Bogor') }}
    </x-slot>
            ...
            <form action="{{ route('submission.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="space-y-4">
                    ...
                    <div>
                        ...
                        <x-text-input type="text" name="tahun_lulus" :value="old('tahun_lulus')" class="w-full px-4 py-2 border border-gray-300 rounded" required />

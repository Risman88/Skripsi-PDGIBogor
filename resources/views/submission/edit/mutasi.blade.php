<x-dashboard-layout>
    @php
        $infoPengajuan = [
            ...
            'Nomor NPA' => $submission->submission_mutasi->npa,
            'Mutasi ke Cabang' => $submission->submission_mutasi->mutasi_ke,
            'Alasan Mutasi' => $submission->submission_mutasi->alasan_mutasi,
        ];
        $scanFiles = [
    ...
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 dark:text-gray-200 leading-tight">
            {{ __('Edit Pengajuan Surat Rekomendasi Mutasi') }}
        </h2>
    </x-slot>
                                        ...
                                        <dd class="mt-1 text-sm text-gray-900 sm:mt-0 sm:col-span-2">
                                            ...
                                            @else
                                                @php
                                                    ...
                                                    if ($key === 'Nomor NPA') {
                                                        $inputName = 'npa';
                                                    } elseif ($key === 'Mutasi ke Cabang') {
                                                        $inputName = 'mutasi_ke';
                                                    } elseif ($key === 'Alasan Mutasi') {
                                                        $inputName = 'alasan_mutasi';
                                                    }
                                                @endphp

<x-dashboard-layout>
    <x-slot name="header">
        {{ __('Pengajuan Surat Pengantar Izin Praktik Dokter Gigi Spesialis untuk Anggota PDGI Kota Bogor') }}
    </x-slot>
            ...
            <div class="space-y-4">
                ...
                <div>
                    ...
                    <select name="tujuan_surat" class="w-full px-4 py-2 border border-gray-300 rounded" required>
                        ...
                        <option value="Pembuatan SIP" {{ old('tujuan_surat') == 'Pembuatan SIP' ? 'selected' : '' }}>
                            Pembuatan SIP</option>
                        <option value="Perpanjangan SIP"
                            {{ old('tujuan_surat') == 'Perpanjangan SIP' ? 'selected' : '' }}>Perpanjangan SIP</option>
                ...
                <div>
                    ...
                    <x-text-input type="text" name="alumni_drg" :value="old('alumni_drg')"
                ...
                <div>
                    ...
                    <x-text-input type="number" name="tahun_lulus" :value="old('tahun_lulus')"
                        class="w-full px-4 py-2 border border-gray-300 rounded" required />
                ...
                <div>
                    ...
                    <x-text-input type="text" name="str" :value="old('str')"
                        class="w-full px-4 py-2 border border-gray-300 rounded" required />
                ...
                <div>
                    ...
                    <input type="file" name="scan_str" class="w-full px-4 py-2 border border-gray-300 rounded"
                        required>
                    <span class= "text-gray-500 text-sm px-1 inline-block">(maksimal ukuran file: 1024 KB, format file:
                        png, jpg, jpeg, atau pdf)</span>
                    <x-input-error :messages="$errors->get('scan_str')" class="mt-2" />
                </div>
                <div>
                    <x-input-label for="serkom" :value="__('Nomor Serkom')" :required="true" />
                    <x-text-input type="text" name="serkom" :value="old('serkom')"
                        class="w-full px-4 py-2 border border-gray-300 rounded" required />
                ...
                <div>
                    ...
                    <input type="file" name="scan_serkom" class="w-full px-4 py-2 border border-gray-300 rounded"
                        required>
                    <span class= "text-gray-500 text-sm px-1 inline-block">(maksimal ukuran file: 1024 KB, format file:
                        png, jpg, jpeg, atau pdf)</span>
                ...
                <div>
                    ...
                    <x-text-input type="text" name="npa" :value="old('npa')"
                        class="w-full px-4 py-2 border border-gray-300 rounded" required />
                ...
                <div>
                    ...
                    <x-text-input type="text" name="cabang_pdgi" :value="old('cabang_pdgi')"
                        class="w-full px-4 py-2 border border-gray-300 rounded" required />
                ...
                <div>
                    ...
                    <input type="file" name="surat_praktik1" class="w-full px-4 py-2 border border-gray-300 rounded"
                ...
                <div>
                    ...
                    <input type="file" name="surat_praktik2"
                        class="w-full px-4 py-2 border border-gray-300 rounded" accept=".png,.jpg,.jpeg,.pdf">
                    <span class= "text-gray-500 text-sm px-1 inline-block">(maksimal ukuran file: 1024 KB, format file:
                        png, jpg, jpeg, atau pdf)</span>
                ...
                <div>
                    ...
                    <input type="file" name="surat_praktik3"
                        class="w-full px-4 py-2 border border-gray-300 rounded" accept=".png,.jpg,.jpeg,.pdf">
                    <span class= "text-gray-500 text-sm px-1 inline-block">(maksimal ukuran file: 1024 KB, format file:
                        png, jpg, jpeg, atau pdf)</span>
                ...
                <div>
                    ...
                    <input type="file" name="scan_surat_sehat"
                        class="w-full px-4 py-2 border border-gray-300 rounded" required>
                    <span class= "text-gray-500 text-sm px-1 inline-block">(maksimal ukuran file: 1024 KB, format file:
                        png, jpg, jpeg, atau pdf)</span>
                ...
                <div>
                    ...
                    <input type="file" name="scan_surat_kolegium"

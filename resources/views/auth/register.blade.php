<x-home-layout>
    ...
    <div class="lg:flex lg:flex-auto justify-center">
        <div class="min-h-screen mt-12 flex flex-col justify-center items-center pt-6 sm:pt-0">
            <div>
                <a href="/">
            ...
            <form method="POST" action="{{ route('register') }}">
                ...
                <div class="mt-4">
                    ...
                    <x-text-input id="tanggal_lahir" class="block mt-1 w-full" type="date" name="tanggal_lahir"
                        :value="old('tanggal_lahir', isset($user) ? $user->tanggal_lahir->format('d/m/Y') : '')" required autocomplete="tanggal_lahir" />
                ...
                <div class="mt-4">
                    ...
                    <x-text-input id="agama" class="block mt-1 w-full" type="text" name="agama"
                        :value="old('agama')" required autocomplete="agama" />
                ...
                <div class="mt-4">
                    ...
                    <x-text-input id="handphone" class="block mt-1 w-full" type="text" name="handphone"
                        :value="old('handphone')" required autocomplete="handphone" />

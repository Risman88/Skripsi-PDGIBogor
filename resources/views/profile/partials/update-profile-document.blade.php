<section>
    <header>
        ...
        <span class="text-gray-500 text-sm px-1 inline-block">Maksimal ukuran file unggah: 1024 KB, format file: png,
            jpg, jpeg, atau pdf</span>
    </header>
    ...
    <form method="post" action="{{ route('user_document.update') }}" enctype="multipart/form-data" class="mt-6 space-y-6">
        ...
        <div>
            ...
            @if ($user->userDocument && $user->userDocument->scan_foto)
                ...
                @endif
            @else
                <input type="file" id="scan_foto" name="scan_foto"
                    class="mt-1 block w-full border border-gray-300">
        ...
        <div>
            ...
            @if ($user->userDocument && $user->userDocument->scan_kta)
                ...
                @endif
            @else
                <input type="file" id="scan_kta" name="scan_kta"
                    class="mt-1 block w-full border border-gray-300">
